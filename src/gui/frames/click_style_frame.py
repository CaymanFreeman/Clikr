...
class ClickStyleFrame(customtkinter.CTkFrame):
    def __init__(self, master: customtkinter.CTk, language_handler: LanguageHandler):
        ...
        self.mouse_button_dropdown = VariableDropdown(self, language_handler=language_handler,
        ...
        self.mouse_button_dropdown.configure(
            variable=tkinter.StringVar(value=language_handler.mouse_buttons[master.getvar(name="MOUSE_BUTTON")]))

        self.clicks_per_event_label = VariableLabel(self, language_handler=language_handler,
                                                    label_key="CLICKS_PER_EVENT_LABEL")
        ...
        self.click_events_entry = IntegerEntry(self, variable_name="CLICK_EVENTS", min_value=0,
