...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.language_frame = LanguageFrame(
            master=self, language_handler=language_handler
        )
        ...
        self.click_length_frame = ClickLengthFrame(
            master=self, language_handler=language_handler
        )
        self.click_length_frame.grid(
            row=2, column=0, padx=frame_padding, pady=frame_padding, sticky="ew"
        )

        self.interval_frame = ClickIntervalFrame(
            master=self, language_handler=language_handler
        )
        ...
        self.click_style_frame = ClickStyleFrame(
            master=self, language_handler=language_handler
        )
        self.click_style_frame.grid(
        ...
        self.start_stop_frame.grid(
            row=7, column=0, padx=frame_padding, pady=frame_padding, sticky="ew"
        )

        self.hotkey_frame = HotkeyFrame(
            master=self,
            start_stop_frame=self.start_stop_frame,
            appearance_handler=appearance_variables,
            language_handler=language_handler,
        )
